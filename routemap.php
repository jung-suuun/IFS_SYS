...
<body>
    <header id="header">
        <div style="float:right">
            <a href="index.php"><p>▶돌아가기◀</p></a>
        </div>
        <div style="float:left">
            <h2>좌표 검색</h2>
            <p><strong>마커 클릭시 해당 장비명 확인 가능. 장비명 클릭시 검색 결과로 이동. 지도 좌측 상단의 버튼을 눌러 로드뷰 이용도 가능합니다.</strong></p>
        </div>
    </header>
</br>
<form name="paging">
...
<script type="text/javascript" src="//dapi.kakao.com/v2/maps/sdk.js?appkey=XXXXXXXXXXXXXXXXXXX"></script>
...
var mapCenter = new kakao.maps.LatLng(37.53477,126.98338), // 지도의 중심좌표
    mapOption = {
    center: new kakao.maps.LatLng(37.53477,126.98338), // 지도의 중심좌표
    level: 8 // 지도의 확대 레벨
    };
...
var imageSrc = 'https://XXXXXXXXXXX/icon_map_cctv2.png'; // 마커이미지 주소
imageSize = new kakao.maps.Size(25, 27);                 // 마커이미지의 크기
imageOption = {offset: new kakao.maps.Point(12, 70)};    // 마커의 좌표와 일치시킬 이미지 안에서의 좌표설정
  
//마커의 이미지정보를 가지고 있는 마커이미지를 생성합니다
var markerImage = new kakao.maps.MarkerImage(imageSrc, imageSize, imageOption);
var arr = new Array();
arr[0] = ["XXXXX",37.52912,127.02238,"http://kko.to/P4ZWNWX0B"];
...
//image: markerImage,
    ...
    contentStr = "<div class='customoverlay'><a href=javascript:gopage('"+ arr[i][0] +"');><span class='title'>"+ arr[i][0] +"</span></a></div>";
...
//오버레이가 열려 있는 상태에서 다른 오버레이를 클릭하면 열려있던 오버레이를 닫히게 만듬
