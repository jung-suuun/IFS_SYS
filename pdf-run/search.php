...
<!-- 플로팅 버튼 -->
<form method="post" action="../r_search.php" class="fltBanner1">
<div style="float:left;"><input type="text" style="width:150px; height:50px; border: 5px solid #000000;" name="c1"></div>	<div style="float:left;"><input type="submit" style="height:55px; letter-spacing: 1px"value="추가검색"></div>
</form>
...
var defaultOptions = {
  ...
  defaultUrl: {
    value: 'pdf-file/<?echo $result[5]?>.pdf?ver=1',
    kind: OptionKind.VIEWER
  },
  defaultZoomValue: {
    value: '',
